            ...
            <table id="results-table" class="table table-bordered" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php for($i=0; $i < count($results); $i++): ?> <tr>
                  ...
                  <td><?php echo e($results[$i]->userid == 1 ? "Bloqueado" : "Desbloqueado"); ?></td>
...
<?php echo $__env->make('template.template-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\midias\resources\views/painel-admin/moodle/index.blade.php ENDPATH**/ ?>